...
## CVPR 2023
- Ziyun Yang et. al., **Directional Connectivity-based Segmentation of Medical Images**. [[pdf]]()
- Yunhao Bai et. al., **Bidirectional Copy-Paste for Semi-Supervised Medical Image Segmentation**. [[pdf]]()
...
- Hritam Basak et. al., **Pseudo-label Guided Contrastive Learning for Semi-supervised Medical Image Segmentation**. [[pdf]]()
- Yuting He et. al., **Geometric Visual Similarity Learning in 3D Medical Image Self-Supervised Pre-training**. [[pdf]]()
- AIMON RAHMAN et. al., **Ambiguous Medical Image Segmentation using Diffusion Models**. [[pdf]]()
- Heng Cai et. al., **Orthogonal Annotation Benefits Barely-supervised Medical Image Segmentation**. [[pdf]]()
- Cheng Jiang et. al., **Hierarchical discriminative learning improves visual representations of biomedical microscopy**. [[pdf]]()
- Yongchao Wang et. al., **MCF: Mutual Correction Framework for Semi-Supervised Medical Image Segmentation**. [[pdf]]()
- Hyungseob Shin et. al., **SDC-UDA: Volumetric Unsupervised Domain Adaptation Framework for Slice-Direction Continuous Cross-Modality Medical Image Segmentation**. [[pdf]]()
- Zeng Qingjie et. al., **PEFAT: Boosting Semi-supervised Medical Image Classification via Pseudo-loss Estimation and Feature Adversarial Training**. [[pdf]]()
- Shiqi Huang et. al., **Rethinking Few-Shot Medical Segmentation: A Vector Quantization View**. [[pdf]]()
